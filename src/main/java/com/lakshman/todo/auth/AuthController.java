...
public class AuthController {
        ...
        public ResponseEntity<ApiResponse<AuthResponse>> googleCallBack(
                ...
                return ResponseBuilders.buildApiOkResponse(authService.loginWithGoogle(request, response));
        }
        ...
        public ResponseEntity<ApiResponse<AuthResponse>> registerUserUsingEmailAndPassword(
                ...
                // call the service
                // do the loggin\
                return ResponseBuilders.buildCreateApiResponse(
                                authService.registerUserUsingEmailAndPassword(request, response));
        }
        ...
        public ResponseEntity<ApiResponse<AuthResponse>> loginUserUsingEmailAndPassword(
                ...
                return ResponseBuilders.buildApiOkResponse(
                                authService.loginUsingEmailAndPassword(request, response, RoleType.USER));
        }
}